...
public class upInput : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            held = true;
            upArrow.transform.localPosition = new Vector3(transform.localPosition.x, 0.2f, transform.localPosition.z);
            ...
            {
                if(perfectHit1.GetComponent<detector>().touchedNote.tag == "upNote" && perfectHit1.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit1.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                ...
                if(perfectHit1.GetComponent<detector>().touchedNote.tag == "longUpNote" && perfectHit1.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit1.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
            ...
            {
                if(perfectHit2.GetComponent<detector>().touchedNote.tag == "upNote" && perfectHit2.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit2.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
                ...
                if(perfectHit2.GetComponent<detector>().touchedNote.tag == "longUpNote" && perfectHit2.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit2.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
            ...
            {
                if(perfectHit3.GetComponent<detector>().touchedNote.tag == "upNote" && perfectHit3.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit3.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
                ...
                if(perfectHit3.GetComponent<detector>().touchedNote.tag == "longUpNote" && perfectHit3.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit3.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
    ...
    void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            held = false;
            upArrow.transform.localPosition = new Vector3(transform.localPosition.x, 0f, transform.localPosition.z);
