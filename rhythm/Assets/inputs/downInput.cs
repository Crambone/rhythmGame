...
public class downInput : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            held = true;
            downArrow.transform.localPosition = new Vector3(transform.localPosition.x, -0.2f, transform.localPosition.z);
            ...
            if(perfectHit1.GetComponent<detector>().touchedNote != null && perfectHit1.GetComponent<detector>().touched == true)
            {
                ...
                if(perfectHit1.GetComponent<detector>().touchedNote.tag == "downNote" && perfectHit1.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit1.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                ...
                if(perfectHit1.GetComponent<detector>().touchedNote.tag == "longDownNote" && perfectHit1.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit1.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
            ...
            {
                if(perfectHit2.GetComponent<detector>().touchedNote.tag == "downNote" && perfectHit2.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit2.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
            ...
            {
                if(perfectHit3.GetComponent<detector>().touchedNote.tag == "downNote" && perfectHit3.GetComponent<detector>().noteDistance > -0.4f * noteFall.GetComponent<noteFall>().speed && perfectHit3.GetComponent<detector>().noteDistance < 0.4f * noteFall.GetComponent<noteFall>().speed)
                {
                    comboManager.GetComponent<combomanager>().comboUpdate();
    ...
    void OnTriggerExit2D(Collider2D other)
    {
        ...
        {
            held = false;
            downArrow.transform.localPosition = new Vector3(transform.localPosition.x, 0f, transform.localPosition.z);
